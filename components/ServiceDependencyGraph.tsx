...
const ServiceDependencyGraph = ({ service }: Props) => {
    ...
    useEffect(() => {
        ...
        }].concat(service.upstreamDependencies.concat(service.downstreamDependencies));
        const links = service.upstreamDependencies.map((dependency) => {
            return {
                source: dependency.id,
                target: service.id,
                label: 'Upstream',
            };
        }).concat(service.downstreamDependencies.map((dependency) => {
            return {
                source: service.id,
